    ...
    plugins: [
        ...
        monkey({
            ...
            userscript: {
                ...
                require: ['https://cdn.jsdelivr.net/npm/exceljs@4.4.0/dist/exceljs.min.js', 'https://cdn.jsdelivr.net/npm/@trim21/gm-fetch', 'https://cdn.jsdelivr.net/npm/jszip@3.10.1/dist/jszip.min.js', 'https://cdn.jsdelivr.net/npm/dayjs@1/dayjs.min.js'],
                "run-at": "document-end",
            },
        }),
    ],
